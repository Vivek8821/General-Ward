...
async function seed() {
  ...
  const mockPatients = [
      ...
      { id: 'u3', name: 'Robert Johnson', dob: '1955-11-04', mrn: 'MRN-1003', bedNumber: '3', diagnosis: 'Congestive Heart Failure', status: 'active', careIntensity: 4, allergies: 'Sulfa Drugs' },
